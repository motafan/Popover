...
public extension UIApplication {
    ...
    var mainWindow: UIWindow? {
        if #available(iOS 13, *) {
            ...
            let windowScene: UIWindowScene = connectedScenes.first as! UIWindowScene
...
class PopoverBackgroundView: UIPopoverBackgroundView {
    ...
    static weak var currPopover: PopoverController?
    ...
    private var design: PopoverDesign!
    private var elegantArrow: PopoverArrow!
    ...
    override var arrowDirection: UIPopoverArrowDirection {
        ...
        set {
            ...
            PopoverBackgroundView.currPopover?.setArrowDirection(self._arrowDirection!)
        }
    }
    ...
    override init(frame: CGRect) {
        ...
        self.design = PopoverBackgroundView.currPopover?.getDesign()
        self.elegantArrow = PopoverBackgroundView.currPopover?.getArrow()
        ...
        if #available(iOS 13, *) {
            ...
            if let window = UIApplication.shared.mainWindow {
                ...
                for transitionView in transitionViews {
                    if  let popoverView = transitionView.subviews.filter({ String(describing: type(of: $0)) == "_UIPopoverView" }).first {
                        let shadowView = popoverView.subviews.filter { String(describing: type(of: $0)) == "_UICutoutShadowView" }.first
    ...
    private func initialize(inset: CGFloat, borderWidth: CGFloat) {
        ...
        arrow = Arrow(apex: CGPoint(x: apexX, y: 0 + inset / cos(atan(elegantArrow.height/(elegantArrow.base/2)))),          
                      height: elegantArrow.height,
    ...
    private func fillPath(with filling: PopoverBorder.Filling) {
