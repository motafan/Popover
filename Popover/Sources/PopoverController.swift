...
/// An object that manages the **Popover**
public class PopoverController: UIViewController, UIPopoverPresentationControllerDelegate {
    ...
    private var arrow: PopoverArrow
     ...
     */
    public init(contentView: UIView, design: PopoverDesign, arrow: PopoverArrow, sourceView: UIView? = nil, sourceRect: CGRect? = nil, barButtonItem: UIBarButtonItem? = nil) {
    ...
    private func setupPopover(_ sourceView: UIView?, _ sourceRect: CGRect?, _ barButtonItem: UIBarButtonItem?) {
        ...
        PopoverBackgroundView.currPopover = self
    ...
    func getDesign() -> PopoverDesign {
        return design
    }
    
    // Returns arrow of the popover
    func getArrow() -> PopoverArrow {
        return arrow
    }
